...
$(function(){$(document).ready(function(){$(".trigger").click(function(e){$(".sideNav").css("transform","translate(0)")}),$(".sideNav__link").click(function(e){$(".sideNav").css("transform","translate(150%)")})}),$(document).ready(function(){var e=$(".changeCategory__btnMonth"),t=$(".changeCategory__btnDay");e.on("click",function(e){$(".row-appartaments--day").addClass("row-appartaments--inactive"),$(".row-appartaments--month").removeClass("row-appartaments--inactive"),$(".changeCategory__btnDay").removeClass("changeCategory__btn--active"),$(this).addClass("changeCategory__btn--active")}),t.on("click",function(t){$(".row-appartaments--day").removeClass("row-appartaments--inactive"),$(".row-appartaments--month").addClass("row-appartaments--inactive"),$(e).removeClass("changeCategory__btn--active"),$(this).addClass("changeCategory__btn--active")})}),$(".discountSlider").slick({slidesToShow:1,slidesToScroll:1,fade:!0,arrows:!0,asNavFor:".discountNavSlider"}),$(".discountNavSlider").slick({slidesToShow:1,slidesToScroll:1,asNavFor:".discountSlider",dots:!1,centerMode:!1,focusOnSelect:!0,arrows:!0}),$(".experienceSlider, .teamSlider").slick({dots:!0,arrows:!0,infinite:!1,slidesToShow:4,slidesToScroll:1,customPaging:function(e,t){$(e.$slides[t]).data()},responsive:[{breakpoint:940,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:700,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:400,settings:{slidesToShow:1,slidesToScroll:1}}]});var e=$(".custom-dots");$(".teamSlider").on("init reInit afterChange",function(t,o,a,n){var i=(a||0)+1;e.text(i+"/"+o.slideCount)}),$(document).ready(function(){$("input, select").styler()}),"undefined"!=typeof WebFont&&(WebFontConfig={custom:{families:["Montserrat"]},active:function(){$("select, :checkbox, :radio").trigger("refresh")}},WebFont.load(WebFontConfig)),$("#datepicker,#datepicker1").datepicker(),$("#datepicker,#datepicker1").datepicker("option","dateFormat","D, d M yy"),$(document).ready(function(){$("a, img").on("dragstart",function(e){e.preventDefault()})}),$(window).scroll(function(e){$(this).scrollTop()>$(this).height()?($(".to-top").addClass("visible"),$(".to-top").removeClass("hidden")):($(".to-top").removeClass("visible"),$(".to-top").addClass("hidden")),$(".to-top").click(function(e){$("html, body").stop().animate({scrollTop:0},"slow")})}),$(document).ready(function(){$("a.link").click(function(e){var t=$(this).attr("href"),o=$(t).offset().top;$("html,body").animate({scrollTop:o},1e3)})}),new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!1,live:!0,callback:function(e){},scrollContainer:null,resetAnimation:!0}).init(),$("#preloader").delay(2e3).fadeOut("slow")});